# world_gen.gd — mesh-based terrain prototype (standalone, no autoload deps)
# Vertex positions and colors are computed on the GPU via a compute shader.
extends Node3D

const DEFAULT_PROTO_CFG_PATH := "res://prototyping/mesh/mesh_proto_world_gen.tres"
...
func _init_compute() -> void:
	...
	var glsl_path := "res://prototyping/mesh/terrain_gen.glsl"
