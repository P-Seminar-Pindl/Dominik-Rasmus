...
const _DefaultInfoPanel = preload("res://prototyping/production/ui/default_info_panel.gd")
const _sidebar_scene := preload("res://prototyping/production/ui/BuildingSidebar.tscn")
const _BuildingSidebar = preload("res://prototyping/production/ui/building_sidebar.gd")
const _ResourceDisplay = preload("res://prototyping/production/ui/resource_display.gd")
...
var _default_panel_scene := preload("res://prototyping/production/ui/DefaultInfoPanel.tscn")
